...
const Footer = () => {
  return (
    <div className={`bg-black backdrop-blur-lg ${poppins.className} `}>
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0 items-center">
            <a
              href="https://github.com/annavaws/my-portfolio"
              target="_blank"
              className="text-gray-100 hover:text-purple-500 hover:scale-105 ease-in-out duration-300 ms-5"
            >
              <svg
                className="w-6 h-6"
                aria-hidden="true"
            ...
            <a
              ...
              target="_blank"
              className="text-gray-100 hover:text-purple-500 hover:scale-105 ease-in-out duration-300 ms-4"
            >
              <svg
                className="w-7 h-7"
                aria-hidden="true"
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=annavaws@gmail.com"
              target="_blank"
              className="text-gray-100 hover:text-purple-500 hover:scale-105 ease-in-out duration-300 mt-1 ms-3"
            >
              <svg
                className="w-10 h-10"
                viewBox="0 0 26 26"
